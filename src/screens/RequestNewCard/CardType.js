  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
        ...
        <Text style={styles._heading}>SELECT A CARD TYPE</Text>

        {CardData.map((v, i) => {
          return (
            <TouchableOpacity
              style={
                activeCard === i ? styles._active_card_main : styles._card_main
              }
              key={i}
      ...
      <View style={styles._btn_main}>
        <Button
          title="Next"
          height={45}
          onPress={() => props.navigation.navigate("DeliveryDetails")}
        />
        <TouchableOpacity
