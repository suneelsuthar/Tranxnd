...
export default function SearchDashboard(props) {
  ...
  const verifyHandler = () => {
    setverify(true);
    setTimeout(() => {
      props.navigation.navigate("ReviewSalries");
    }, 2500);
  };
  let CardData = [
    {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Header />
      <SimpleHeader title="Disburse Salaries" onPress={() => props.navigation.goBack()} right={<Ionicons name="add-outline" size={24} color={Theme.primary} />} />
