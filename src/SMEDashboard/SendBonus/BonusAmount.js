...
export default function BonusAmount(props) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles._sroll_view}>
        <Text style={styles._heading}>Bonus Amount</Text>
        <Text style={styles._sub_heading}>Please enter amount to transfer!</Text>
        <TextInput
      ...
      <View style={styles._btn_main}>
        <Button title="Continue" height={45} onPress={() => props.navigation.navigate("BonusReview")} />
