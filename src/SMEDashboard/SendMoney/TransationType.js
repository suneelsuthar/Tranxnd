...
export default function TransationType(props) {
  ...
  let CardData = [
    ...
    {
      icon: <User width={40} height={40} fill={Theme.primary} />,
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles._btn_main}>
        <Button title="Continue" height={45} onPress={() => props.navigation.navigate("SearchDashboard")} />
